...
public class TopTenVideoAdapter extends RecyclerView.Adapter<TopTenVideoAdapter.myHodler> {
    private Context context;
    List<Feed> feedList;
    ImageShow imageShow;
    private static final String TAG = "MyAdapterVideo";

    public TopTenVideoAdapter(Context context, List<Feed> feedList, ImageShow imageShow) {
