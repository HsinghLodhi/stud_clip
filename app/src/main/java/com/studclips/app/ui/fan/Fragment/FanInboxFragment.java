...
public class FanInboxFragment extends Fragment implements ChatThreadAdapter.OnClickItem, TextWatcher {
    Unbinder unbinder;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fan_inbox_fragment_layout, container, false);
        context = getContext();
    ...
    private void onCreateData() {
        etSearch.addTextChangedListener(FanInboxFragment.this);
